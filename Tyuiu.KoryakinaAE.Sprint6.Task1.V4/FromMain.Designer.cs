namespace Tyuiu.KoryakinaAE.Sprint6.Task1.V4
{
    partial class FromMain
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.labelText1_MKA.Text = "Протабулировать функцию (sin(x)/x+1,2 ) -sin(x) * 2 - 2x на заданном диапазоне.";
            // 
            ...
            // buttonHelp_MKA
            // 
            buttonHelp_MKA.FlatStyle = FlatStyle.Flat;
            buttonHelp_MKA.Location = new Point(592, 406);
            buttonHelp_MKA.Name = "buttonHelp_KAE";
            buttonHelp_MKA.Size = new Size(43, 32);
            buttonHelp_MKA.TabIndex = 8;
            buttonHelp_MKA.Text = "?";
            buttonHelp_MKA.UseVisualStyleBackColor = true;
            buttonHelp_MKA.Click += buttonHelp_MKA_Click;
            // 
            // buttonDone_MKA
            // 
            buttonDone_MKA.BackColor = System.Drawing.Color.Green;
            buttonDone_MKA.Location = new System.Drawing.Point(408, 366);
            buttonDone_MKA.Name = "buttonDone_MKA";
            buttonDone_MKA.Size = new System.Drawing.Size(146, 72);
            buttonDone_MKA.TabIndex = 4;
            buttonDone_MKA.Text = "Выполнить";
            buttonDone_MKA.UseVisualStyleBackColor = false;
            buttonDone_MKA.Click += buttonDone_MKA_Click;
            // 
            // FormMain
            // 
            ...
            this.Text = "Спринт 6 | Таск 1 | Вариант 4 | Корякина А.Э.";
